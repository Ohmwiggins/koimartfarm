            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                <Typography variant="body2" color="text.primary" sx={{ lineHeight: 1.6 }}>
                  ตั้งแต่ผมยังเด็ก จนถึงช่วงวัยรุ่น ผมได้รับผิดชอบการดูแลปลาคาร์ปด้วยความรู้สึกสนุกและตื่นเต้น ในช่วงเวลานั้น ผมได้เห็นหลายสิ่งหลายอย่างจากการเปลี่ยนแปลง และพัฒนาการในด้านต่างๆ ของปลา...
                </Typography>

                <Typography variant="body2" color="text.primary" sx={{ lineHeight: 1.6 }}>
                  ทั้งการเติบโตที่มีสีสันสดใส ลวดลายที่สวยงาม ดูแปลกตาในแต่ละสายพันธุ์ ไปจนถึงรูปร่างโครงสร้างที่ใหญ่โตของตัวปลา อีกทั้งเรื่องราวความเป็นมาของปลาคาร์ปที่มีมายาวนานนับพันปี และความหมายของการเลี้ยงที่มีเอกลักษณ์ สื่อถึงความอุดมสมบูรณ์ ความมั่งคั่ง และร่ำรวย
                </Typography>

                <Typography variant="body2" color="text.primary" sx={{ lineHeight: 1.6 }}>
                  ด้วยเสน่ห์เหล่านี้... จึงเป็นแรงบันดาลใจที่อยากจะถ่ายทอดความรู้สึกและความหมายดีๆ ในการเลี้ยงปลาคาร์ป ซึ่งถือว่าเป็นงานอดิเรกที่ทุกคนเข้าถึงได้
                </Typography>

                <Typography variant="body2" color="text.primary" sx={{ lineHeight: 1.6 }}>
                  ไม่ว่าจะเป็นเด็ก หนุ่มสาว วัยทำงาน คนเกษียณ ผู้หญิง หรือผู้ชาย ก็สามารถเข้าถึงความสุขที่อิ่มเอมได้ทุกช่วงวัยไปพร้อมๆ กันได้อย่างลงตัว และยังเป็นศูนย์กลางของความสุขในครอบครัวได้เป็นอย่างดี
                </Typography>

                <Typography variant="body2" color="text.primary" sx={{ lineHeight: 1.6 }}>
                  ความรู้สึกดีๆ เหล่านี้ เป็นที่มาของความสุขที่ผมสามารถแชร์ถึงทุกๆ คนได้ ผ่านทาง "โค่ยมาร์ทฟาร์ม" (Koi Mart Farm)
                </Typography>
              </Box>
              <Box>
